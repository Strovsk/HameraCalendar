...
export class HemeraCalendar implements IMediator {
  ...
  constructor(options: AppOptions = Config.appOptions) {
    ...
    this.calendarActionBar = new Components.CalendarActionBar(
      this.engine,
      this
    );
    this.calendarSelectionPin = new Components.CalendarSelectionPin(
      this.engine,
      this
    );
    this.calendarMasterContainer = new Components.CalendarMasterContainer(
      this.engine,
      this
    );

    this.calendarMasterContainer.container.appendChild(
      this.calendarHeader.container
    );
    this.calendarMasterContainer.container.appendChild(
      this.calendarDays.container
    );
    this.calendarMasterContainer.container.appendChild(
      this.calendarDates.container
    );
    this.calendarMasterContainer.container.appendChild(
      this.calendarMonths.container
    );
    this.calendarMasterContainer.container.appendChild(
      this.calendarActionBar.container
    );
    this.calendarMasterContainer.container.appendChild(
      this.calendarSelectionPin.container
    );
